...
var require = function require(id) {
    ...
    filename = require.dir + id + ".js"; //! TODO support require.paths?
    ...
    if (!require._cache.hasOwnProperty(filename)) {
        ...
        try {
        ...
        catch(e) { //! added code to print stack trace in Rhino
			if(e.rhinoException != null) {
				print("Can't load module '" + origid + "'");
			...
			else throw new Error("Can't load module '" + origid + "' - " + e);
        }
    ...
    function gettext(url) {
        ...
        //! added code to read file text in Rhino
